...
// @version      1.3
// @description  ? = List Hotkeys, / = search,  A = aspect-ratio cycle,  I = playback info,  Shift+Esc = home, S = Subtitle Menu
// @match        *://*/web/*
// @author       n00bcodr
// @grant        none
    ...
    document.addEventListener('keydown', (e) => {
        ...
        if (e.key === '?' || (e.shiftKey && e.key === '/')) {
            ...
            help.style = `
                ...
                border-radius: 12px; z-index: 99999; font-size: 18px; backdrop-filter: blur(15px);
